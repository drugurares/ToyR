		...
		if ($this->_numb_of_pages > 1) {
			...
			if ($this->_current > 1) {
				...
				$url = $id > 1 ? 
					...
					$this->_url;
				$out[] = "<a href=\"{$url}\">Anterioara</a>";
				
			} else {
				$out[] = "<span>Anterioara</span>";
			}
			...
			if ($this->_current != $this->_numb_of_pages) {
				...
				$out[] = "<a href=\"{$url}\">Urmatoarea</a>";
				
			} else {
				$out[] = "<span>Urmatoarea</span>";
			}
			...
			if ($this->_current != $this->_numb_of_pages) {
				...
				$out[] = "<a href=\"{$url}\">Ultima</a>";
			} else {
				$out[] = "<span>Ultima</span>";
			}
