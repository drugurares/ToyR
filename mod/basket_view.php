...
<?php if (!empty($out)) { ?>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
		<tr>
			...
			<th class="ta_r col_15">Elimina</th>
		</tr>
		...
		<tr>
			...
			<td class="ta_r br_td"><?php echo number_format($objBasket->_sub_total, 2); ?> Lei</td>
			<td class="ta_r br_td">&#160;</td>
		</tr>
		<tr>
			<td colspan="2" class="br_td">TVA (<?php echo $objBasket->_vat_rate; ?>%):</td>
			<td class="ta_r br_td"><?php echo number_format($objBasket->_vat, 2); ?> Lei</td>
			<td class="ta_r br_td">&#160;</td>
		</tr>
		...
		<tr>
			...
			<td class="ta_r br_td"><strong><?php echo number_format($objBasket->_total, 2); ?> Lei</strong></td>
			<td class="ta_r br_td">&#160;</td>
		</tr>
	</table>
