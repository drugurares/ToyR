...
<div id="wrapper">
	...
	<h3>Comanda numarul:<?php echo " ".$id; ?></h3>
	
	<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
		
		<tr>
			<th>Produse</th>
			<th class="ta_r">Cantitate</th>
		...
		<?php foreach($items as $item) { ?>
			...
			<tr>
				...
				<td class="ta_r">
					<?php echo number_format($objBasket->itemTotal($item['price'], $item['qty']), 2); ?> Lei
				</td>
			</tr>
		...
		<?php if ($order['vat_rate'] != 0) { ?>
			...
			<tr>
				...
				<td class="ta_r br_td">
					<?php echo number_format($order['subtotal'], 2); ?> Lei
				</td>
			</tr>
			
			<tr>
				<td colspan="2" class="br_td">
					TVA (<?php echo $order['vat_rate']; ?>%):
				</td>
				<td class="ta_r br_td">
					<?php echo number_format($order['vat'], 2); ?> Lei
				</td>
			</tr>
		...
		<tr>
			<td colspan="2" class="br_td"><strong>Total cu TVA:</strong></td>
			<td class="ta_r br_td">
	...
	<p><a href="#" onclick="window.print(); return false;">Printeaza factura.</a></p>
