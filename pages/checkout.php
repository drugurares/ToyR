...
if (!empty($user)) {
	...
	if ($objForm->isPost('first_name')) {
		...
		if ($objValid->isValid()) {
			...
			if ($objUser->updateUser($objValid->_post, $user['id'])) {
				...
				$mess  = "<p class=\"red\">A aparut o problema la updatarea detaliilor.<br />";
				$mess .= "Va rugam contactati administratorul.</p>";
			}
	...
	<p>Va rugam reverificati si apasati <strong>Next</strong>.</p>
	...
	<form action="" method="post">
		<table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
			...
			<tr>
				<th><label for="first_name">Nume: *</label></th>
				<td>
			...
			<tr>
				<th><label for="last_name">Prenume: *</label></th>
				<td>
			...
			<tr>
				<th><label for="address_1">Adresa 1: *</label></th>
				<td>
			...
			<tr>
				<th><label for="address_2">Adresa 2:</label></th>
				<td>
			...
			<tr>
				<th><label for="town">Oras: *</label></th>
				<td>
			...
			<tr>
				<th><label for="county">Judet: *</label></th>
				<td>
			...
			<tr>
				<th><label for="post_code">Cod postal: *</label></th>
				<td>
